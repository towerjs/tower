...
echo "    1. pnpm create tower test-app"
echo "    2. Select: typescript, no tailwind (or tailwind), modules: gatehouse + vault"
echo "    3. cd test-app"
echo "    4. pnpm install"
...
echo ""
echo "  Manual steps:"
echo "    1. docker compose up postgres"
echo "    2. cd examples/with-nextjs"
echo "    3. Set DATABASE_URL=postgres://tower:tower@localhost:5432/tower in .env"
echo "    4. pnpm install"
echo "    5. pnpm build"
echo "    6. pnpm test:e2e  ← all auth flows should pass"
