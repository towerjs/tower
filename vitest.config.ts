...
const aliases = [
  ...
  { find: /^@towerjs\/vault\/factory$/, replacement: resolve('packages/vault/src/factory.ts') },
  { find: /^@towerjs\/vault\/model$/, replacement: resolve('packages/vault/src/model.ts') },
  { find: /^@towerjs\/vault$/, replacement: resolve('packages/vault/src/index.ts') },
  { find: /^@towerjs\/scribe\/cli$/, replacement: resolve('packages/scribe/src/cli.ts') },
  { find: /^@towerjs\/gatehouse\/src\/(.*)$/, replacement: resolve('packages/gatehouse/src/$1') },
