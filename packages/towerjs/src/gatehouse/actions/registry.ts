...
export const authActions: AuthActionConfig[] = [
  ...
  // ── Members ──────────────────────────────────────────────────────
  { name: 'addMember',          path: 'organizations.members.add', fields: ['organizationId', 'userId', 'role'], positional: true },
  { name: 'updateMemberRole',   path: 'organizations.members.update', fields: ['memberId', 'role', 'organizationId'], positional: true },
