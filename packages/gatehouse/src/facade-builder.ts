...
const GET_METHODS = new Set([
  "getSession", "listSessions", "listPasskeys", "listOrganizations",
  "listMembers", "listInvitations", "listOrgRoles", "listUsers",
  "getUser", "getOrganization", "getFullOrganization", "getInvitation",
  "getOrgRole", "getApiKey", "listApiKeys", "listUserAccounts",
  "listUserSessions", "getAccessToken", "getTOTPURI",
  "accountInfo", "getActiveMember", "getActiveMemberRole",
  "getVerificationOTP", "listUserInvitations", "viewBackupCodes",
