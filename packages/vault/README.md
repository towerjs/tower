...
export default defineTower({
  modules: [vault({ provider: 'pg', connectionString: env.string('DATABASE_URL') })],
})
```
...
- [@towerjs/tower](https://www.npmjs.com/package/@towerjs/tower) — core (Vault is an optional `@towerjs/vault` module that depends on the core)
