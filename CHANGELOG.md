...
- Initial release of Tower, a composable, monolithic stack for JavaScript applications.
  ...
  - **Scribe CLI** — Interactive scaffolding via `pnpm create tower`, plus `tower migrate`, `tower migrate --seed`, `tower seed`, and `tower seed --skip-migrate` for database migrations and seeding.
