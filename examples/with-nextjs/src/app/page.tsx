      ...
      <main className="flex-1">
        <section className="mx-auto max-w-3xl px-6 pt-32 pb-20 text-center">
          <h1 className="text-5xl font-bold tracking-tight text-neutral-900">
            ...
            <br />
            <span className="text-neutral-500">production-grade apps</span>
          </h1>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                description: 'Email (Resend, SES, SMTP), SMS (Twilio), and Web Push through a unified API.',
              },
            ].map((item) => (
              <div key={item.title} className="rounded-lg border border-neutral-200 p-6">
